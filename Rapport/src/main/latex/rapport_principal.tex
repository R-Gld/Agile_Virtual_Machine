...
\usepackage{listings}
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, arrows, positioning, trees, shapes}
\usepackage{xcolor}
\usepackage{titlesec}
\usepackage{fancyhdr}
...
\begin{document}
    ...
    \begin{titlepage}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.45\textwidth]{images/logo_universite.png}
            \hspace{1cm}
            \includegraphics[width=0.35\textwidth]{images/logo_ufr.png}
        \end{figure}
        ...
        {\Large MiniJAJA - Compilateur et Interpréteur}\\[0.3cm]
        {\Large Groupe 7}
