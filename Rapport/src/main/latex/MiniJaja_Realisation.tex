...
%=============================================================================
\subsection{Interprétation JajaCode}
%=============================================================================

\subsubsection{Refactoring : du switch monolithique au Pattern Command}

L'implémentation initiale de l'interpréteur JajaCode reposait sur une structure monolithique (une classe unique de plus de 1200 lignes avec un immense switch/case), ce qui rendait la maintenance et le débogage extrêmement ardus.

Nous avons opéré une refonte complète de l'interpréteur en appliquant le \textit{Pattern Command}. Chaque instruction JajaCode (ex: \texttt{add}, \texttt{push}, \texttt{invoke}) est désormais encapsulée dans sa propre classe (nommée "Axiome" dans notre architecture) qui implémente une interface commune d'exécution.

\textbf{Avantages constatés :}
\begin{itemize}
    \item \textbf{Maintenabilité :} Cela fragmente la complexité. Chaque classe est responsable d'une seule instruction, rendant le code lisible.
    \item \textbf{Extensibilité :} L'ajout d'une nouvelle instruction ne demande pas de modifier le moteur central, mais simplement de créer une nouvelle classe.
\end{itemize}

\subsubsection{Encapsulation du contexte d'exécution}

Pour orchestrer l'exécution de ces commandes, nous avons introduit une classe \texttt{MachineContext}.

Plutôt que de passer des références éparses à la Pile, au Tas, à chaque instruction, l'objet \texttt{MachineContext} encapsule l'intégralité de la mémoire et de l'adressage. Les instructions interagissent uniquement avec ce contexte, assurant une forte cohésion des données.

\subsubsection{Gestion des erreurs et testabilité JajaCode}

Chaque "Axiome" a été conçu pour lever des exceptions spécifiques en cas d'échec (ex: \texttt{StackUnderflowException}, \texttt{TypeMismatchException}). Ce choix a été piloté par la stratégie de test. En typant fortement les exceptions, nous avons pu écrire des tests unitaires précis pour chaque instruction, validant non seulement le succès des opérations mais aussi leur robustesse face aux cas limites.

%=============================================================================
\subsection{Interprétation MiniJaja}
%=============================================================================
...
\subsubsection{Mémoire et Interprétation:}
...
\newpage
%=============================================================================
\subsection{Synthèse des Erreurs et Exceptions}
%=============================================================================

Le projet distingue deux familles d'erreurs principales :
...
%=============================================================================
\subsection{Bilan des choix de réalisation}
%=============================================================================

Les choix de conception et d'implémentation du compilateur/interpréteur MiniJaja incluent :
